...
import avisoConfidencialidad from '../../assets/pdfs/Aviso_de_Confidencialidad_WasakaBe.pdf'
import terminosyCondiciones from '../../assets/pdfs/Terminos_y_Condiciones_WasakaBe.pdf'
      ...
      <div className="wk-footer__inner">
        ...
        <section className="wk-footer__col">
          ...
          <ul className="wk-footer__list">
            ...
            <li>
              <a className="wk-link" href={terminosyCondiciones}>
        ...
        <section className="wk-footer__col wk-footer__col--right">
          ...
          <div className="wk-social">
            <a aria-label="Facebook" className="wk-social__btn" href="https://www.facebook.com/profile.php?id=61580855264467" rel="noopener">
